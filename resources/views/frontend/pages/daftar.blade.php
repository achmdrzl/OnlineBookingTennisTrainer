                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="sc_price_block sc_price_block_style_2">
                                                <div class="sc_price_block_title">
                                                    <span>{{ ucfirst($item->nama_lapangan) }} ({{ ucfirst($item->jenis_lap) }})</span>
                                                </div>
                                                <div class="sc_price_block_money">
                                                    <div class="sc_price">
                                                        ...
                                                        <span class="sc_price_period"> jam</span>
                                                    </div>
                                                </div>
                                                <div class="text-center">
                                                    <span class="sc_price_money"><img
                                                            src="{{ asset('storage/uploads/img/' . $item->gambar_lap) }}"
                                                            alt="" width="180px" class="mb-5"></span>
                                                </div>
                                                <div class="sc_price_block_description" style="margin-top: -20px">
                                                   ...
                                                   Alamat Lapangan : {{ ucfirst($item->alamat_lap) }}

                                                </div>
                                                <div class="sc_price_block_link">
                                                    <a href="{{ route('order.jadwal', $item->id) }}"
